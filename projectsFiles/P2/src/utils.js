...
const makeColor = (red, green, blue, alpha = 1) => {
  ...
  const getRadialGradient = (ctx,startX,startY,sRad,endX,endY,eRad,colorStops) => {
    let lg = ctx.createRadialGradient(startX,startY,sRad,endX,endY,eRad);
  ...
  export {makeColor, getRandomColor, getRadialGradient, goFullscreen};